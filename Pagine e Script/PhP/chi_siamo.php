					...
					<div class="intestazione_chi_siamo">
						<div class="container_intestazione_chi_siamo">
							<span class="icona_chi_siamo">
								<img src="../../Immagini/clock-rotate-left-solid.svg" alt="Icona Chi Siamo" />
							</span>
							<h2>Chi Siamo?</h2>
						</div>
					</div>
						...
						<div class="container_storia">
							...
							<div class="foto">
								<div class="container_foto" title="LEV all'inizio del suo viaggio">
									<img src="../../Immagini/Inizio-Di-Tutto.jpg" alt="LEV all'inizio del suo viaggio" />
									<div class="memories">
							...
							<div class="foto">
								<div class="container_foto" title="LEV in costante miglioramento">
									<img src="../../Immagini/Una-Crescita-Esponenziale.jpg" alt="LEV in costante miglioramento" />
									<div class="memories">
							...
							<p>Oltre a essere un negozio online, siamo una <strong>comunità di appassionati</strong>. Sosteniamo e incoraggiamo lo <strong>scambio di idee</strong> e la <strong>condivisione di esperienze</strong> tra i nostri clienti. Le vostre opinioni e suggerimenti sono fondamentali per <strong>guidare il nostro futuro</strong>. Infatti, sin dagli albori abbiamo avuto l'<storng>intenzione di crescere e innovarci</strong> volta per volta. Proprio per questo, stiamo gi&agrave; pianificando nuove iniziative per offrire un'<strong>esperienza ancora più gratificante</strong> ai nostri clienti.</p>
							<div class="foto">
								<div class="container_foto" title="LEV rivolta al futuro">
									<img src="../../Immagini/Prossimi-Passi.jpg" alt="LEV rivolta al futuro" />
									<div class="memories">
