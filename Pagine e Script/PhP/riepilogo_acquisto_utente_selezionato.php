...
<?php
	// LA PAGINA PERMETTE DI VISUALIZZARE A SCHERMO TUTTI I DETTAGLI INERENTI ALL'ACQUISTO DI UN CLIENTE SELEZIONATO DA UNO DEI GESTORI DELLA PIATTAFORMA
	...
	$sql="SELECT Nome, Cognome, Num_Telefono FROM $tab WHERE ID=".$_GET["id_Utente_Selezionato"]." AND Tipo_Utente='C'";
	$result=mysqli_query($conn, $sql);
	
	// QUALORA L'UTENTE INSERITO RISULTI INESISTENTE, BISOGNERÀ IMPEDIRE CHE CI SIANO DEGLI ERRORI LEGATI ALLA COMPOSIZIONE DELLA PAGINA
	// PROPRIO PER QUESTO, SI PROCEDERÀ CON IL REINDIRIZZAMENTO DELL'UTENTE VERSO LA PAGINA DI RIEPILOGO INERENTE AI PRECEDENTI
					...
					<div class="container_form">
						<div class="intestazione_form">
							<div class="container_intestazione_form">
								...
								<h2>Visualizza l'acquisto dell'utente selezionato!</h2>
							</div>
						</div>
						<form class="corpo_form" action="riepilogo_acquisti_utente_selezionato.php" method="get">
