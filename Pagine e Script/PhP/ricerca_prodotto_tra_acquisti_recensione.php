<?php
	// LO SCRIPT PERMETTE DI STABILIRE SE IL PRODOTTO COINVOLTO IN UNA DETERMINATA RECENSIONE È STATO ACQUISTATO O MENO DAL CLIENTE CHE L'HA SCRITTA 
	...
	for($j=0; $j<$acquisti->length && !$prodotto_acquistato; $j++) {
		...
		if($acquistiPerCliente->getAttribute("idCliente")==$recensione->getAttribute("idUtente")) {
